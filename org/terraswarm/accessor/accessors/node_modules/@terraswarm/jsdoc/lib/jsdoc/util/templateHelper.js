...
function buildLink(longname, linkText, options) {
    ...
    //console.log("templateHelper.js.buildLink(" + longname + ", " + linkText + "...)");
    // handle cases like:
    ...
    if (!fileUrl) {
        //console.log("templateHelper.js.buildLink() !fileURL text: " + text);
        return text;
    }
    else {
        //console.log("templateHelper.js.buildLink() fileURL: " + fileUrl + ", " + fragmentString + ", " + classString + ", " + text);
